  ...
  return (
    <footer className="flex flex-col justify-center p-4 bg-base-300 text-base-content bg-gradient-to-b from-cyan-500">
      ...
      <div className="text-cyan-700 text-center mt-8">
        <p>
          Copyright © 2024 - All rights reserved by <span className="font-bold font-dancing text-lg"> Kareim </span>
        </p>
        <p>
          Powered by{' '}
          <a href="https://www.worldweatheronline.com/weather-api/" target="_blank" rel="noopener noreferrer">
            World Weather API
          </a>
        </p>
      </div>
